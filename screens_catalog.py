...
SCREEN_IDS = [
    ...
    "bears logo", "bears next", "nfl logo", "NFL Scoreboard", "nba logo", "NBA Scoreboard",
    "hawks logo", "hawks last", "hawks live", "hawks next", "hawks next home", "nhl logo", "NHL Scoreboard",
